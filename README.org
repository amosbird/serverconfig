...
cd bspwm && make -j && sudo make install

cd ~/git
git clone git@github.com:amosbird/reptyr
cd reptyr && make -j && sudo make install

cd ~/git
git clone git@github.com:amosbird/cgdb
cd cgdb && ./autogen.sh && ./configure && make -j && sudo make install

cd ~/git
git clone git@github.com:amosbird/tmux
cd tmux && sh autogen.sh && ./configure && make -j && sudo make install
...
cd ~/git
git clone git@github.com:amosbird/libvte
cd libvte && ./autogen.sh && ./configure --enable-vala=no && make -j && sudo make install

cd ~/git
git clone --recursive git@github.com:amosbird/termite
cd termite && make -j && sudo make install
...
cd ~/git
git clone git@github.com:amosbird/htop-vim
cd htop-vim && ./autogen.sh && ./configure && make -j && sudo make install
...
cd mu && sh autogen.sh && make -j && sudo make install
