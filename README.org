...
trizen -S librime-git rofi-emoji bspwm-git copyq-git feh-git freerdp-git llpp-git netevent-git obs-studio-git termite-git vte3-git xcape-git caps-indicator  --noconfirm --needed
