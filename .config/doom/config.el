...
(defun +amos*popup-display-buffer-stacked-side-window (buffer alist)
...
(advice-add #'+popup-display-buffer-stacked-side-window :override #'+amos*popup-display-buffer-stacked-side-window)
