function tmuxgdb -d ""
  ...
  tmux send-keys "cgdb -- -tty $tty3 -ex \"dashboard threads -output $tty1\" -ex \"dashboard stack -output $tty1\" -ex \"dashboard expression -output $tty4\" -ex \"dashboard registers -output $tty2\" $argv" C-m
end
